...
sgMail.setApiKey(process.env.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)
const msg = {
  to: currentUser, // Change to your recipient
  from: 'smsmit0771@ung.edu', // Change to your verified sender
    title: eventTitle.value,
    description: eventDescription.value,
    dueDate: eventDueDate.value,
}
sgMail
  .send(msg)
  .then(() => {
...
// Immediately check reminders once on page load
checkReminders();

// Also check reminders when the page becomes visible again
